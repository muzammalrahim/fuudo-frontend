...
export default function AddRestaurant () {
  ...
  const { name, email, password, confirmPassword, description, phoneNo, address} = restaurant;
  ...
  const onSubmit = async e => {
    ...
    try {
      ...
      const apiRes = await post("/admin/createRestaurant", payload)
      console.log("restaurantApi", apiRes);
      setRestaurant(apiRes.data);
      ...
      <div className="w-75 mx-auto shadow p-5">
        ...
        <ValidationForm onSubmit={e => onSubmit(e)}>
          ...
          <div>
              ...
              <div className='row'>
                <div className='col-9'><TextInput type="file" id="file" successMessage="" errorMessage="Please choose the image" required onChange={(e)=>{
